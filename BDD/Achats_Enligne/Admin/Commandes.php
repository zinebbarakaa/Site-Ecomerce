                        ...
                        if($row_count<=0)
                            {
                               ...
                               echo '<td colspan="7">Rien na été trouvé dans la base de données.</td>' ;
                        ...
                        else
                            {
                                ...
                                echo '
                                    ...
                                    <td>Montant</td>
                                    <td>Etat Paiment</td>
                                    <td>(QtCmd,Id Article)</td>
                                    <td>Valider Laivraison</td>
                                 </tr>';
                               ...
                               while ($row=sqlsrv_fetch_array($res,SQLSRV_FETCH_ASSOC))
                                 ...
                                 echo '
                                    <tr>
                                        <td>
                                            '.$row['PrenomUtilisateur'].' '.$row['NomUtilisateur'].'
                                        </td> 
                                        <td>
                                            '.$row['IdFacture'].'
                                        </td>         
                                        <td>
                                            +212'.$row['TelUtilisateur'].'
                                        </td>
                                        <td>
                                            '.$row['MontantFacture'].'
                                        </td>';  
                                        if(trim($row['StatusFacture'])=='P')
                                        {
                                           echo  '<td>Paiment avec carte bancaire</td>';
                                                   
                                        }
                                        else 
                                        {
                                            echo  '<td>Paiment à livraison</td>';
                                                   
                                        }
                                           
                                        echo '
                                            <td>
                                                ('.$row['QtCmd'].','.$row['IdArticle'].')
                                            </td>
                                            <td >
                                                <a href="Livraison.php?idfacture='.$idFacture.'"><i class="fas fa-plus"></i></a> 
                                            </td>
                                    </tr>
                                ';
